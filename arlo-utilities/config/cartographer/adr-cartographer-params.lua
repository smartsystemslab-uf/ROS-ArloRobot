...
options = {
  ...
  num_subdivisions_per_laser_scan = 553,
  num_point_clouds = 0,
...
TRAJECTORY_BUILDER_2D.num_accumulated_range_data = 553
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 1440
...
MAP_BUILDER.num_background_threads = 2 -- Increase up to number of cores
POSE_GRAPH.global_sampling_ratio = 0.00001 -- Decrease
POSE_GRAPH.constraint_builder.sampling_ratio = 0.0001 -- Decrease
POSE_GRAPH.constraint_builder.min_score = 1.0 -- Increase
POSE_GRAPH.global_constraint_search_after_n_seconds = 5 -- Increase
...
--TRAJECTORY_BUILDER_2D.submaps.resolution = 0.2 -- Increase
