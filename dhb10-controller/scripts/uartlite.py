...
#from https://raw.githubusercontent.com/parthpower/axi_uartlite_pynq/master/src/uartlite.py
...
class UartAXI:
    def __init__(self, address, mem_mapped=False, register_rw=False):
        # Setup axi core
        self.uart = MMIO(address, 0x10000, debug=False, mem_mapped=mem_mapped, register_rw=register_rw)
